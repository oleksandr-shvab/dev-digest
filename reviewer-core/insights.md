...
Append-only log of things learned the hard way while working in
`reviewer-core/`. Read before starting work here (see root
[`CLAUDE.md`](../CLAUDE.md)'s Session protocol); append through the
